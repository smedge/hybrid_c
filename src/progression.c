...
static ProgressionEntry entries[SUB_ID_COUNT] = {
	...
	[SUB_ID_TGUN] = { "TGUN", "sub_tgun", FRAG_TYPE_TGUN, 30, false },
	[SUB_ID_SPRINT] = { "SPRINT", "sub_sprint", FRAG_TYPE_SPRINT, 10, false },
	[SUB_ID_EMP] = { "EMP", "sub_emp", FRAG_TYPE_EMP, 30, false },
	...
	[SUB_ID_FLAK]      = { "FLAK",      "sub_flak",      FRAG_TYPE_FLAK,      30, false },
	...
	[SUB_ID_HEATWAVE]  = { "HEATWAVE",  "sub_heatwave",  FRAG_TYPE_HEATWAVE,  30, false },
